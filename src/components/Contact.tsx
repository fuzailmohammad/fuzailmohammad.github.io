...
export const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:mohdfuzail00786@gmail.com?subject=${subject}&body=${body}`;
  };
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'mohdfuzail00786@gmail.com',
    ...
    },
    {
      icon: Github,
      label: 'GitHub',
      value: 'github.com/mohdfuzail',
      href: 'https://github.com/mohdfuzail',
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                type="submit"
                className="w-full flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300"
